...
function initializeGalleryAlbumSwiperJS() {
    ...
    */
    var albumSwiper = new Swiper(".myAlbumSwiper", {
        ...
        speed: 500,
        navigation: {
            nextEl: ".swiper-button-next-gallery-album",
...
function initializePhotogallerySwiperJS() {
    ...
    var myGalleryPreviewThumbsSwiper = new Swiper("#myGalleryPreviewThumbsSwiper", {
        slidesPerView: 2,
        spaceBetween: 10,
        loop: true,
        centeredSlides: false,
        ...
        /*on: {
            click(event) {
                ...
                myGalleryPreviewThumbsSwiper.slideTo(this.clickedIndex);
            },
        }*/
    });
    var myPhotoGalleryPreviewSwiper = new Swiper(".myGalleryPreviewSwiper", {
        spaceBetween: 10,
        slidesPerView: 1,
        loop: true,
        navigation: {
        ...
        thumbs: {
            swiper: myGalleryPreviewThumbsSwiper,
        },
    });
}
...
var openLightboxByClickingImage = () => {
    ...
    // get swiper
    const myPreviewSwiper = document.querySelector('.myGalleryPreviewSwiper').swiper;
    ...
    // get gallery lightbox header:
    const galleryLightboxHeaderAlbumTitle = document.querySelector('#gallery-lightbox-header-album-title');

    allImageCards.forEach((imageCard, idx) => {
        imageCard.addEventListener('click', (e) => {

            lightbox.style.display = 'flex';
            galleryLightboxHeaderAlbumTitle.innerHTML = e.target.parentElement.dataset.albumname;
...
var closeLightboxByClickingX = () => {
    ...
    // x-Button:
    const xButton = document.getElementById('gallery-lightbox-preview-close');
    // Modal Window
    const lightbox = document.getElementById("gallery-lightbox");
